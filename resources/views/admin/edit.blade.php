...
<body>
 <span style="color:red">
     ...
     @if(!empty(session('msg')))
         {{session('msg')}}
     @endif</span>
<form  method="POST" action="updateSys">
    {{csrf_field()}}
    <table class="table table-bordered table-hover definewidth m10" style="margin-left:3%;margin-top:2%;">
        <tr>
            ...
            <td><input type="text" name="num" value="{{$count}}" style="height: 15px; width: 56px"/></td>

        </tr>
        {{--<tr>--}}
            {{--<td class="tableleft">投票开始时间:</td>--}}
            {{--<td style="height: 46px; "> <div style="margin:0 auto;">--}}
                    {{--<input type="text" id="time1" name="time_start" value="选择时间" onClick="return Calendar('time1');" class="text_time"/>--}}
                {{--</div>--}}
            {{--</td>--}}
        {{--</tr>--}}
        {{--<tr>--}}
            ...
            {{--<td> <div style="margin:0 auto;">--}}
                    {{--<input type="text" id="time2" name="time_end" value="选择时间" onClick="return Calendar('time2');" class="text_time"/>--}}
                {{--</div>--}}
            {{--</td>--}}
        {{--</tr>--}}
        <tr>
